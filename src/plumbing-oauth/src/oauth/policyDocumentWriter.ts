...
export class PolicyDocumentWriter {
     ...
     */
    public static invalidTokenResponse(event: any): CustomAuthorizerResult {
     ...
     */
    private static _policyDocument(userId: string, effect: string, event: any, context: any): CustomAuthorizerResult {
