...
const RequestHandlingClass = require('../src/put-profile');
const updateMemberProfile = new RequestHandlingClass(consumerApi, updateMemberProfileSchema);
...
exports.handler = async (event, context) => {
    ...
    const response = await lambdaExecutionAdapter(async () => {
        ...
        return await updateMemberProfile.process(memberId, payload)
    });
